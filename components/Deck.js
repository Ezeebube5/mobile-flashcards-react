  ...
  return deck ? (
    <View style={styles.container}>
      ...
      <View style={styles.btnGroup}>
        ...
        >
          <Text style={[styles.text, { color: "black" }]}>Create a new question</Text>
        </TouchableOpacity>
        {deck.questions.length !== 0 && (
          <TouchableOpacity
            style={[styles.button, { backgroundColor: "#F68E5F" }]}
          ...
          >
            <Text style={[styles.text, { color: "white" }]}>Start Quiz on {deck.title}</Text>
          </TouchableOpacity>
        )}
